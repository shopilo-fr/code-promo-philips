#!/usr/bin/env python3
"""
Recuperation des codes promo Philips depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/philips.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/philips.fr"
STORE_NAME = "Philips"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Philips depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-philips)"
    }
    try:
